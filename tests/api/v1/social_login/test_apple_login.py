...
def mock_social_login_service():
    with patch("app.api.v1.service.social_login_service.SocialLoginService") as MockSocialService:
...
async def test_apple_login_success(mock_apple_service, mock_social_login_service):
    ...
    mock_social_login_service.apple_login = AsyncMock(return_value={

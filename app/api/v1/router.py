...
api_router.include_router(user_profile.router, prefix="/auth/user_profile", tags=["profile"])
api_router.include_router(device.router, prefix="/auth/device", tags=["Device Invite"])
api_router.include_router(
